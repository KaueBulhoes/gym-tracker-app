...
- [Criação de Plano de Treino](criacao-plano-treino.md) — criação de planos com divisão ABCDE, dias da semana ou personalizada (persistência mock in-memory, Supabase pendente)
